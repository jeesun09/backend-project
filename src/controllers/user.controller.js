...
const generateAccessAndRefreshTokens = async (userId) => {
  try {
    ...
    throw new ApiError(
      500,
      "Something went worng while generating refresh and access tokens"
    );
  }
};
...
const loginUser = asyncHandler(async (req, res) => {
  ...
  console.log("User Login successful: ", loggedInUser.username);
  ...
  return res
    ...
    .json(
      new ApiResponse(
        200,
        user[0].watchHistory,
        "Watch History Fetchd Successfully"
      )
    );
});
